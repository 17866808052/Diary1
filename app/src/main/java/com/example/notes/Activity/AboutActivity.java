    ...
    private void chooseCopyContent(){
        ...
        dialog.setListener_1(new MyOnClickListener() {
            ...
            public void onClick() {
                ...
                manager.setText("aaaaaaa@163.com");
                MsgToast.showToast(AboutActivity.this,"复制e-mail成功!");

            }
        });

        dialog.setChoose2("百度");
        dialog.setListener_2(new MyOnClickListener() {
            @Override
            public void onClick() {
                ClipboardManager manager = (ClipboardManager) getSystemService(Context.CLIPBOARD_SERVICE);
                manager.setText("https://www.baidu.com");

                MsgToast.showToast(AboutActivity.this,"复制网址成功!");
            }
        });
